                  ...
                  <table width="520" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 1px 4px rgba(0,0,0,0.08);">
                    ...
                    <tr>
                      <td style="padding:40px;">
                        ...
                        <p style="margin:0;font-size:13px;color:#a1a1aa;line-height:1.6;">
                          This code expires in <strong style="color:#71717a;">30 minutes</strong>. If you didn't create a Glint account, you can safely ignore this email.
                        </p>
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td style="background:#fafafa;border-top:1px solid #f0f0f0;padding:20px 40px;">
                        <p style="margin:0;font-size:12px;color:#a1a1aa;">© 2025 Glint · You're receiving this because you signed up.</p>
                      </td>
                    </tr>
